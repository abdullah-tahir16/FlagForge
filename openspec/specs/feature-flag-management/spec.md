...
The system SHALL allow an authenticated user to update enabled state and boolean value for a feature flag configuration in a project environment.
...
The system SHALL seed local demo feature flags for the demo project.
...
- **THEN** the seed updates or preserves the demo feature flags without creating duplicates
